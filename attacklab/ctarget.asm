...
00000000004010e0 <main>:
  ...
  401185:	be a5 31 40 00       	mov    $0x4031a5,%esi
...
000000000040178c <touch1>:
  ...
  401797:	00 00 00 
  40179a:	bf f7 2f 40 00       	mov    $0x402ff7,%edi
...
00000000004017b8 <touch2>:
  ...
  4017d0:	bf 20 30 40 00       	mov    $0x403020,%edi
  ...
  4017eb:	bf 48 30 40 00       	mov    $0x403048,%edi
...
000000000040180e <hexmatch>:
  ...
  401859:	be 14 30 40 00       	mov    $0x403014,%esi
...
000000000040188c <touch3>:
  ...
  4018af:	bf 70 30 40 00       	mov    $0x403070,%edi
  ...
  4018cd:	bf 98 30 40 00       	mov    $0x403098,%edi
...
00000000004018f0 <test>:
  ...
  401900:	bf c0 30 40 00       	mov    $0x4030c0,%edi
...
000000000040198b <check_fail>:
  ...
  4019a1:	bf e3 30 40 00       	mov    $0x4030e3,%edi
...
0000000000401a0c <notify_server>:
  ...
  401a33:	bf 18 32 40 00       	mov    $0x403218,%edi
  ...
  401a70:	b9 f9 30 40 00       	mov    $0x4030f9,%ecx
  401a75:	eb 05                	jmp    401a7c <notify_server+0x70>
  401a77:	b9 fe 30 40 00       	mov    $0x4030fe,%ecx
  ...
  401a8e:	be 03 31 40 00       	mov    $0x403103,%esi
  ...
  401ae8:	bf 1f 31 40 00       	mov    $0x40311f,%edi
  ...
  401b2a:	be f9 30 40 00       	mov    $0x4030f9,%esi
  401b2f:	90                   	nop
  401b30:	eb 05                	jmp    401b37 <notify_server+0x12b>
  401b32:	be fe 30 40 00       	mov    $0x4030fe,%esi
  401b37:	bf 80 32 40 00       	mov    $0x403280,%edi
  ...
  401b4d:	bf 3c 31 40 00       	mov    $0x40313c,%edi
  ...
  401b63:	bf 49 31 40 00       	mov    $0x403149,%edi
  ...
  401b79:	bf 55 31 40 00       	mov    $0x403155,%edi
  ...
  401b8f:	00 
  401b90:	bf 5e 31 40 00       	mov    $0x40315e,%edi
...
0000000000401ba9 <validate>:
  ...
  401bbd:	bf 6a 31 40 00       	mov    $0x40316a,%edi
  ...
  401bdd:	bf a8 32 40 00       	mov    $0x4032a8,%edi
  ...
  401c04:	bf 88 31 40 00       	mov    $0x403188,%edi
  ...
  401c1d:	bf 6a 31 40 00       	mov    $0x40316a,%edi
  ...
  401c3e:	bf d0 32 40 00       	mov    $0x4032d0,%edi
...
0000000000401d6d <sigalrmhandler>:
  ...
  401d7a:	bf e4 31 40 00       	mov    $0x4031e4,%edi
  ...
  401d93:	bf 80 33 40 00       	mov    $0x403380,%edi
...
0000000000401dbb <launch>:
  ...
  401df0:	bf ec 31 40 00       	mov    $0x4031ec,%edi
...
0000000000401e3c <stable_launch>:
  ...
  401e86:	be b8 33 40 00       	mov    $0x4033b8,%esi
...
00000000004028aa <init_driver>:
  ...
  402949:	bf e8 2e 40 00       	mov    $0x402ee8,%edi
  ...
  4029ec:	66 c7 44 24 02 47 26 	movw   $0x2647,0x2(%rsp)
...
0000000000402a73 <driver_post>:
  ...
  402abc:	be 26 47 00 00       	mov    $0x4726,%esi
  402ac1:	bf e8 2e 40 00       	mov    $0x402ee8,%edi
